    ...
    return(
        <>
            <form type="submit" onSubmit={props.Submit} style={{ display: "flex", flexDirection:"column",alignItems:"center" }}>
             ...
             <label style={props.labelStyleForMediumAdmin} htmlFor="Title"><input type="text" placeholder="Title" id="Title" onChange={props.onchangeTitle}></input></label>
             ...
             <div style={{border:"1px solid black",width:"80%",display:"flex",justifyContent:"space-evenly"}}>
               <label style={props.labelStyleForMediumAdmin} htmlFor="Category"><input type="text" placeholder="Category" id="Category" onChange={props.onchangeCategory}></input></label>
              <label style={props.labelStyleForMediumAdmin} htmlFor="Price"><input type="text" placeholder="Price" id="Price" onChange={props.onchangePrice}></input></label>
              </div>
              <div style={{border:"1px solid black",width:"80%",display:"flex",justifyContent:"space-evenly"}}>
              ...
              <button type="submit" style={props.buttonStyleForSamllAdmin} onClick={props.Submit} >Submit</button>
              </div>
            </form>
